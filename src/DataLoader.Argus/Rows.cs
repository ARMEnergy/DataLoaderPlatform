...
/// <see cref="ArgusFeedDescriptor.Columns"/>.
///
/// <para>
/// This is deliberately NOT a per-feed POCO. There are 16 feeds whose only
/// difference is their column list, so 16 row classes would mean 16
/// <c>BuildTable</c> methods — 16 independent chances for the DataTable/TVP
...
/// </para>
/// </summary>
public sealed class ArgusRow
{
    public ArgusRow(object[] values) => Values = values;
